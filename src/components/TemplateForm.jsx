...
const serviceIcons = {
  ...
  'GenSpark': <Search className="h-4 w-4" />,
  'Felo': <Search className="h-4 w-4" />,
...
const defaultServices = [
  ...
  { id: 'genspark', name: 'GenSpark', url: 'https://www.genspark.ai/', genre: 'Search' },
  { id: 'felo', name: 'Felo', url: 'https://felo.ai/ja/search', genre: 'Search' },
  { id: 'perplexity', name: 'Perplexity', url: 'https://www.perplexity.ai/', genre: 'Search' },
];
